...
\-pandas, DataFrame, groupby(), value\_counts(), mean(), max(), min(), sort\_values(), iterrows(), Conditional Statements, f-strings
...
5\. What  is the average total\_score for students with attendance above 90%?
